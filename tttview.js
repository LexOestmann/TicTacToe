export default class GameView {
    constructor(root) {
        ...
        // When the tile gets clicked run this function going to pass through the index specified above
    ...
    updateAlert(game) {
        ...
        this.root.querySelector(".alert").textContent = alert;
    }
    updateBoard(game) {
